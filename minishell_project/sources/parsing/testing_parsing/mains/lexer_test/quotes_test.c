...
/*   Updated: 2025/07/19 16:55:37 by abaryshe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	input = "\"I am $USER and you?\"\"|The status:
// $?\"+miaou31USER$COLORTERM$WHATTPATH$USER|MIOUA_mi_ER=hehehehe";
// 	i = 0;
...
// 	input = "'$miaou$''|$USER|'+miaou31USER$COLORTERM
// $WHATTPATH$USER|MIOUA_mi_ER=hehehehe";
// 	i = 0;
